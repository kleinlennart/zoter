...
To access your own private library you will need your userID (not your username!) and an API Key. You can find them here: [https://www.zotero.org/settings/keys](https://www.zotero.org/settings/keys/new)
